      ...
      <ContactStyle>
        <div className="contact-outer">
          <div className="contact-form-left">
            ...
            <form
              name="download_french"
              method="POST"
              netlify-honeypot="bot-field"
              data-netlify="true"
              action="/fr-fr/thank-you-for-your-submission"
            >
              <input type="hidden" name="form-name" value="download_french" />
              <p className="hidden">
                <label>
              ...
              <div>
                <input
                  ...
                  id="family-size"
                  name="family-size"
                  placeholder="Taille des Familles"
                />
              </div>
              <div className="interested">
                Vous êtes intéressé par l’achat d’une maison principalement
                pour:
              </div>
              <div className="apply">
              ...
              <div className="download-chech">
                <div>
                  ...
                  <label for="own-hom-live-at-teranga">
                    {" "}
                    Posséder une maison / Résider à Teranga Estates
                  </label>
                </div>
                <div>
                  <input
                ...
                <div>
                  <input
                    ...
                    value="undecided"
                  />
                  <label for="undecided"> Indécis</label>
                </div>
              </div>
